-- Stock theme with following changes:
...
view.element_color[view.ELEMENT_SELECTION_BACK] = colors.light_yellow
-- view.element_color[view.ELEMENT_SELECTION_ADDITIONAL_TEXT] = colors.light_black
view.element_color[view.ELEMENT_SELECTION_ADDITIONAL_BACK] = colors.light_yellow
-- view.element_color[view.ELEMENT_SELECTION_SECONDARY_TEXT] = colors.light_black
view.element_color[view.ELEMENT_SELECTION_SECONDARY_BACK] = colors.light_yellow
-- view.element_color[view.ELEMENT_SELECTION_INACTIVE_TEXT] = colors.light_black
view.element_color[view.ELEMENT_SELECTION_INACTIVE_BACK] = colors.light_yellow
...
-- Long Lines.
view.edge_color = colors.white

-- Find & replace pane entries.
ui.find.entry_font = font .. ' ' .. size

-- Current line highlight
view.caret_line_back = colors.white
